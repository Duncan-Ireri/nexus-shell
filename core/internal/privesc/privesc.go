...
// EnvOverride returns the tool selected by the $NEXUS_PRIVESC env var (if any)
...
// than one is installed and $NEXUS_PRIVESC is not set. If stdin is not a TTY,
