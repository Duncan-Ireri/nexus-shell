...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/log"
	"github.com/nexus-shell/nexus-shell/core/internal/matugen"
	...
	"github.com/nexus-shell/nexus-shell/core/internal/server/trayrecovery"
	...
	"github.com/nexus-shell/nexus-shell/core/internal/server/wlcontext"
...
const dbusClientID = "nexus-dbus-client"

var capabilitySubscribers syncmap.Map[string, chan ServerInfo]
var cupsMu sync.Mutex
var cupsSubscriberCount int

var appPaths = paths.New("nexus")
