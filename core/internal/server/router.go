...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/server/apppicker"
	"github.com/nexus-shell/nexus-shell/core/internal/server/bluez"
	"github.com/nexus-shell/nexus-shell/core/internal/server/brightness"
	"github.com/nexus-shell/nexus-shell/core/internal/server/clipboard"
	"github.com/nexus-shell/nexus-shell/core/internal/server/cups"
	serverDbus "github.com/nexus-shell/nexus-shell/core/internal/server/dbus"
	serverDgop "github.com/nexus-shell/nexus-shell/core/internal/server/dgop"
	"github.com/nexus-shell/nexus-shell/core/internal/server/evdev"
	"github.com/nexus-shell/nexus-shell/core/internal/server/freedesktop"
	"github.com/nexus-shell/nexus-shell/core/internal/server/location"
	"github.com/nexus-shell/nexus-shell/core/internal/server/loginctl"
	"github.com/nexus-shell/nexus-shell/core/internal/server/mime"
	"github.com/nexus-shell/nexus-shell/core/internal/server/models"
	"github.com/nexus-shell/nexus-shell/core/internal/server/network"
	"github.com/nexus-shell/nexus-shell/core/internal/server/notifyactions"
	serverPlugins "github.com/nexus-shell/nexus-shell/core/internal/server/plugins"
	serverRegistries "github.com/nexus-shell/nexus-shell/core/internal/server/registries"
	"github.com/nexus-shell/nexus-shell/core/internal/server/sysupdate"
	"github.com/nexus-shell/nexus-shell/core/internal/server/tailscale"
	"github.com/nexus-shell/nexus-shell/core/internal/server/thememode"
	serverThemes "github.com/nexus-shell/nexus-shell/core/internal/server/themes"
	"github.com/nexus-shell/nexus-shell/core/internal/server/wallpaper"
	"github.com/nexus-shell/nexus-shell/core/internal/server/wayland"
	"github.com/nexus-shell/nexus-shell/core/internal/server/wlroutput"
)
