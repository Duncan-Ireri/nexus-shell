...
const envServe = "_NEXUS_CLIPBOARD_SERVE"
const envMime = "_NEXUS_CLIPBOARD_MIME"
const envPasteOnce = "_NEXUS_CLIPBOARD_PASTE_ONCE"
const envCacheFile = "_NEXUS_CLIPBOARD_CACHE"
