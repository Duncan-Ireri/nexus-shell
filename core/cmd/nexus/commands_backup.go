...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/backup"
...
var backupCmd = &cobra.Command{
	Use:   "backup",
	Short: "Backup and restore nexus-shell configuration",
}

var backupCreateCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a tar.gz backup of ~/.config/NexusShell (settings, plugins, themes)",
	Args:  cobra.NoArgs,
	Run:   runBackupCreate,
}
...
var backupRestoreCmd = &cobra.Command{
	Use:   "restore <archive>",
	Short: "Restore a nexus-shell configuration backup; the current configuration is moved aside first",
