...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/registries"
...
var registryCmd = &cobra.Command{
	...
	Long:  "Manage the registries nexus-shell fetches plugins and themes from. The official registry is always active; additional registries can be added by name and git URL.",
}
