...
var openCmd = &cobra.Command{
	...
	Long: `Open a target (URL, file, or other resource) using the nexus-shell application picker.
...
Examples:
  nexus open https://example.com                    # Open URL with browser picker
  nexus open file.pdf                               # Open file (MIME auto-detected)
  nexus open file.pdf --mime application/pdf        # Override MIME detection
  nexus open document.odt --category Office         # Open with office applications`,
