...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/plugins"
	"github.com/nexus-shell/nexus-shell/core/internal/server"
	"github.com/nexus-shell/nexus-shell/core/internal/shellembed"
...
var ipcCmd = &cobra.Command{
	Use:   "ipc",
	Short: "Send IPC commands to running nexus-shell shell",
	Long: `Send IPC commands to the running nexus-shell shell.

  nexus ipc call <target> <function> [args...]   invoke a command
  nexus ipc list                                 list all targets and functions
...
var debugSrvCmd = &cobra.Command{
	...
	Long:  "Start the Unix socket debug server for nexus-shell",
	Run: func(cmd *cobra.Command, args []string) {
...
var pluginsCmd = &cobra.Command{
	Use:   "plugins",
	Short: "Manage nexus-shell plugins",
	Long:  "Browse and manage nexus-shell plugins from the registry",
}

var pluginsBrowseCmd = &cobra.Command{
	Use:   "browse",
	Short: "Browse available plugins",
	Long:  "Browse available plugins from the nexus-shell plugin registry",
	Run: func(cmd *cobra.Command, args []string) {
...
var pluginsListCmd = &cobra.Command{
	...
	Long:  "List all installed nexus-shell plugins",
	Run: func(cmd *cobra.Command, args []string) {
...
var pluginsInstallCmd = &cobra.Command{
	...
	Long:  "Install a nexus-shell plugin from the registry using its ID (e.g., 'myPlugin'). Plugin names with spaces are also supported for backward compatibility.",
...
var pluginsUninstallCmd = &cobra.Command{
	...
	Long:  "Uninstall a nexus-shell plugin using its ID (e.g., 'myPlugin'). Plugin names with spaces are also supported for backward compatibility.",
	Args:  cobra.ExactArgs(1),
	ValidArgsFunction: func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		if len(args) != 0 {
			return nil, cobra.ShellCompDirectiveNoFileComp
...
var pluginsUpdateCmd = &cobra.Command{
	...
	Long:  "Update an installed nexus-shell plugin using its ID (e.g., 'myPlugin'). If --all or -a is specified, all installed plugins will be updated.",
