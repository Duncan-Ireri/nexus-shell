...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/blur"
	"github.com/nexus-shell/nexus-shell/core/internal/clipboard"
	"github.com/nexus-shell/nexus-shell/core/internal/config"
	"github.com/nexus-shell/nexus-shell/core/internal/distros"
	...
	"github.com/nexus-shell/nexus-shell/core/internal/tui"
	"github.com/nexus-shell/nexus-shell/core/internal/utils"
	"github.com/nexus-shell/nexus-shell/core/internal/version"
...
var doctorCmd = &cobra.Command{
	Use:   "doctor",
	Short: "Diagnose nexus-shell installation and dependencies",
	Long:  "Check system health, verify dependencies, and diagnose configuration issues for nexus-shell",
	Run:   runDoctor,
}
...
func checkFonts() []checkResult {
	...
	if configDir, err := os.UserConfigDir(); err == nil {
		settingsPath := filepath.Join(configDir, "NexusShell", "settings.json")
