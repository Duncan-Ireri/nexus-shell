...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/qsipc"
)
...
func printIPCHelp() {
	fmt.Println("Usage: nexus ipc call <target> <function> [args...]")
	fmt.Println()
...
func printIPCHelpFailure(err error) {
	...
	fmt.Println("  Try:        nexus ipc call <target> <function>")
}
