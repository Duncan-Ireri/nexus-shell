...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/errdefs"
	"github.com/nexus-shell/nexus-shell/core/internal/log"
	"github.com/nexus-shell/nexus-shell/core/internal/netfetch"
	"github.com/nexus-shell/nexus-shell/core/internal/privesc"
...
var updateCmd = &cobra.Command{
	Use:     "update",
	Short:   "Update NexusShell to the latest version",
	Long:    "Update NexusShell to the latest version using the appropriate package manager for your distribution",
...
var updateCheckCmd = &cobra.Command{
	Use:   "check",
	Short: "Check if updates are available for NexusShell",
...
func runUpdateCheck() {
	fmt.Println("Checking for NexusShell updates...")
	fmt.Println()
...
func updateArchLinux() error {
	...
	fmt.Printf("This will update NexusShell using %s.\n", helper)
	if !confirmUpdate() {
		return errdefs.ErrUpdateCancelled
	}
...
func updateOtherDistros() error {
	...
	fmt.Println("  2. NexusShell configuration using git")
	if !confirmUpdate() {
		return errdefs.ErrUpdateCancelled
	}
