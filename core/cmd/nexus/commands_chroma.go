...
import (
	...
	"github.com/nexus-shell/nexus-shell/core/internal/highlight"
	"github.com/nexus-shell/nexus-shell/core/internal/highlight/lexers"
	"github.com/nexus-shell/nexus-shell/core/internal/highlight/styles"
...
Examples:
  nexus chroma main.go
  nexus chroma --language python script.py
  echo "def foo(): pass" | nexus chroma -l python
  cat code.rs | nexus chroma -l rust --style dracula
  nexus chroma --markdown README.md
  nexus chroma --markdown --style github-dark notes.md
  nexus chroma list-languages
  nexus chroma list-styles`,
