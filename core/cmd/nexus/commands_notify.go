...
Examples:
  nexus notify "Hello" "World"
  nexus notify "File received" "photo.jpg" --file ~/Downloads/photo.jpg --icon smartphone
  nexus notify "Download complete" --file ~/Downloads/file.zip --app "My App"`,
...
func init() {
	notifyCmd.Flags().StringVar(&notifyAppName, "app", "Nexus Shell", "Application name")
