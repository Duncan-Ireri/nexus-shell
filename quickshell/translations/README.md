# NexusShell Translations

This directory contains translation files for NexusShell extracted from all qsTr() calls in the QML codebase.
...
```bash
cd /home/brandon/.config/quickshell/NexusShellGit/translations
