...
Singleton {
    ...
    readonly property bool useHyprlandFocusGrab: isHyprland && Quickshell.env("NEXUS_HYPRLAND_EXCLUSIVE_FOCUS") !== "1"
    ...
    function powerOffMonitors() {
        ...
        if (isLabwc) {
            Quickshell.execDetached(["nexus", "dpms", "off"]);
        }
    ...
    function powerOnMonitors() {
        ...
        if (isLabwc) {
            Quickshell.execDetached(["nexus", "dpms", "on"]);
        }
