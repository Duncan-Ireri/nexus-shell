...
Singleton {
    ...
    readonly property string socketPath: Quickshell.env("NEXUS_SOCKET")
    ...
    Component.onCompleted: {
        ...
        if (!socketPath || socketPath.length === 0) {
            log.info("NEXUS_SOCKET not set, network backend unavailable");
            return;
        }
        ...
        log.debug("NEXUS_SOCKET found, waiting for capabilities...");
    }
