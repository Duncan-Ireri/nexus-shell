...
Item {
    ...
    MouseArea {
        ...
        onClicked: mouse => {
            ...
            if (mouse.button === Qt.MiddleButton) {
                ...
                if (!contextMenu)
                    return;
                const shouldHidePin = appData.appId === "org.quickshell" || appData.appId === "sh.nexus.shell";
    ...
    Item {
        ...
        IconImage {
            ...
            anchors.centerIn: parent
            implicitSize: appData && (appData.appId === "org.quickshell" || appData.appId === "sh.nexus.shell") ? actualIconSize * 0.85 : actualIconSize
            source: {
                if (!appData || appData.appId === "__SEPARATOR__") {
                    return "";
                }
            ...
            layer.enabled: appData && (appData.appId === "org.quickshell" || appData.appId === "sh.nexus.shell")
            layer.smooth: true
            layer.mipmap: true
