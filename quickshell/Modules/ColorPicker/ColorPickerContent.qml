...
FocusScope {
    ...
    function copyColorToClipboard(colorValue) {
        Quickshell.execDetached(["nexus", "cl", "copy", colorValue]);
    ...
    function pickColorFromScreen() {
        ...
        Proc.runCommand("dms-color-pick", [Proc.dmsBin, "color", "pick", "--json"], (output, exitCode) => {
            if (exitCode !== 0) {
                log.warn("nexus color pick exited with code:", exitCode);
                showRequested();
                return;
            }
            try {
                    ...
                    Row {
                        ...
                        DankActionButton {
                            ...
                            onClicked: () => {
                                ...
                                Quickshell.execDetached(["nexus", "cl", "copy", rgbString]);
                    ...
                    Row {
                        ...
                        DankActionButton {
                            ...
                            onClicked: () => {
                                ...
                                Quickshell.execDetached(["nexus", "cl", "copy", hsvString]);
