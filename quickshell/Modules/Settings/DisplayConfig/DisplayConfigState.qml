...
Singleton {
    ...
    function showHyprlandReadOnlyWarning() {
        ToastService.showWarning(I18n.tr("Hyprland conf mode"), I18n.tr("This install is still using hyprland.conf. Run nexus setup to migrate before changing these settings."), "nexus setup", "display-config");
    }
