            ...
            StyledRect {
                ...
                Row {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: warningBox.showLegacy ? I18n.tr("This install is still using hyprland.conf. Run nexus setup to migrate before changing these settings.") : I18n.tr("Click 'Setup' to create %1 and add include to your compositor config.").arg("dms/windowrules")
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                            wrapMode: Text.WordWrap
                            width: parent.width
