            ...
            Column {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        StyledText {
                            id: ipcText
                            text: "nexus ipc call desktopWidget toggleOverlay " + root.instanceId
                            font.pixelSize: Theme.fontSizeSmall
                        ...
                        DankButton {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            onClicked: {
                                Quickshell.execDetached(["nexus", "cl", "copy", "nexus ipc call desktopWidget toggleOverlay " + root.instanceId]);
