...
Item {
    ...
    function validateAndApplyAuthSource(path) {
        ...
        authValidateProcess.command = ["nexus", "auth", "validate", "--path", path, "--json"];
    ...
    function validateAndApplyU2fSource(path) {
        ...
        u2fValidateProcess.command = ["nexus", "auth", "validate", "--purpose", "u2f", "--path", path, "--json"];
    ...
    Process {
        ...
        command: ["nexus", "auth", "list-services", "--json"]
        running: false
