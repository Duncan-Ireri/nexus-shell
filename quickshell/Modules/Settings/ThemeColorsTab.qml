    ...
    component IncludeWarningBox: StyledRect {
        ...
        Row {
            ...
            Column {
                ...
                StyledText {
                    text: includeWarningBox.showLegacy ? I18n.tr("This install is still using hyprland.conf. Run nexus setup to migrate before changing these settings.") : I18n.tr("Click 'Setup' to create %1 and add include to your compositor config.").arg(includeWarningBox.fragmentPath)
                            ...
                            Repeater {
                                ...
                                Rectangle {
                                    ...
                                    property string previewPath: {
                                        const baseDir = Quickshell.env("HOME") + "/.config/NexusShell/themes/" + (modelData.sourceDir || modelData.id);
                                    ...
                                    MouseArea {
                                        ...
                                        cursorShape: Qt.PointingHandCursor
                                        onClicked: {
                                            const themesDir = Quickshell.env("HOME") + "/.config/NexusShell/themes";
