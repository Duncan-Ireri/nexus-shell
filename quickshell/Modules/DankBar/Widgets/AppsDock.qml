...
BasePill {
    ...
    function buildBaseItems() {
        ...
        sortedToplevels.forEach((toplevel, index) => {
            ...
            if (rawAppId === "org.quickshell" || rawAppId === "sh.nexus.shell") {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    IconImage {
                        ...
                        layer.enabled: appItem.appId === "org.quickshell" || appItem.appId === "sh.nexus.shell"
                        layer.smooth: true
                        layer.mipmap: true
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.RightButton) {
                            ...
                            if (contextMenuLoader.item) {
                                ...
                                const shouldHidePin = modelData.appId === "org.quickshell" || modelData.appId === "sh.nexus.shell";
                                const moddedId = Paths.moddedAppId(modelData.appId);
