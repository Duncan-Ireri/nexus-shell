                ...
                Item {
                    ...
                    Item {
                        ...
                        ElevationShadow {
                            ...
                            shadowEnabled: !root.frameOwnsConnectedChrome && root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("NEXUS_DISABLE_LAYER") !== "true" && Quickshell.env("NEXUS_DISABLE_LAYER") !== "1"
                        }
