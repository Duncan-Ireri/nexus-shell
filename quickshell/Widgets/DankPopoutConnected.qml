            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("NEXUS_DISABLE_LAYER") !== "true" && Quickshell.env("NEXUS_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive) && !root.frameOwnsConnectedChrome
                    }
                    ...
                    Item {
                        ...
                        readonly property bool shadowsOn: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("NEXUS_DISABLE_LAYER") !== "true" && Quickshell.env("NEXUS_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive)
