...
Singleton {
    ...
    readonly property url data: `${StandardPaths.standardLocations(StandardPaths.GenericDataLocation)[0]}/NexusShell`
    readonly property url state: `${StandardPaths.standardLocations(StandardPaths.GenericStateLocation)[0]}/NexusShell`
    readonly property url cache: `${StandardPaths.standardLocations(StandardPaths.GenericCacheLocation)[0]}/NexusShell`
    readonly property url config: `${StandardPaths.standardLocations(StandardPaths.GenericConfigLocation)[0]}/NexusShell`
    ...
    function getAppName(appId: string, desktopEntry: var): string {
        if (appId === "org.quickshell" || appId === "sh.nexus.shell") {
            return "Nexus Shell";
        }
